...
app.config["DEBUG"] = False # mudamos para False para evitar problemas com threads
...
if __name__ == "__main__":
    socketio.run(app, host='localhost', port=5000, debug=False, use_reloader=False) # define que o app vai rodar no seu servidor local
